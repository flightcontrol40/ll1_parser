function createHeader(pageTitle) {
  ...
  cellContent.innerHTML = "Dr. \"Joules BC\" Beeston - UIdaho";
  ...
  //////////////////// DEBUG Make nicer buttons for all three
  cellContent = document.createElement('a');
  cellContent.href = "https://webpages.uidaho.edu/drbc/";
  img = document.createElement('img');
  img.src = "https://webpages.uidaho.edu/drbc/images/home.jpg";
  img.style["width"] = "12%";
  cellContent.style["width"] = "100%";
  //cellContent.align = "center";
  //cellContent.style["align"] = "center";
  cellContent.appendChild(img); 
  mycell.appendChild(cellContent);  
  ////////////////////
  newRow.appendChild(mycell);
